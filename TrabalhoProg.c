...
tTabuleiro InicializaTabuleiro(tJogador jogador, char * diretorio);
...
int main(int argc, char * argv[]){
	...
	jogador1.campoJogador = InicializaTabuleiro(jogador1, argv[1]);
	jogador2.campoJogador = InicializaTabuleiro(jogador2, argv[1]);
...
tTabuleiro InicializaTabuleiro(tJogador jogador, char * diretorio){
	...
	char tipoDePeca [10]="\0"; // nenhuma pe�a tem mais que 10 caracteres
	int peca=0;
	jogador.arquivoTabuleiro = fopen(jogador.enderecoTabuleiro, "r");
	if(jogador.arquivoTabuleiro=='\0'){
	...
	while(!feof(jogador.arquivoTabuleiro)){
		...
		fscanf(jogador.arquivoTabuleiro, "%*c");
...
void realizaJogo(tJogador jogador1, tJogador jogador2, char * endereco){
	while(todosOsNaviosAfundaram(jogador1.campoJogador)==0 && todosOsNaviosAfundaram(jogador2.campoJogador)==0){
		jogador2.campoJogador=jogaJogador(jogador1.nome, jogador2.campoJogador);
		printf("Tabuleiro atual de %s apos a jogada de %s\n", &jogador2.nome, &jogador1.nome);
		printaTabuleiro(jogador2.campoJogador);
		jogador1.campoJogador=jogaJogador(jogador2.nome, jogador1.campoJogador);
